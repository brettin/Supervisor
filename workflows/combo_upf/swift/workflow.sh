...
export BENCHMARK_DIR=$BENCHMARKS_ROOT/Pilot1/Combo:$BENCHMARKS_ROOT/Pilot1/Combo
...
usage()
{
  echo "Combo UNROLLED: usage: workflow.sh SITE EXPID CFG_SYS UPF"
}
